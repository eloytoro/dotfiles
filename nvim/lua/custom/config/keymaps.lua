...
set('n', '<leader>d', vim.diagnostic.setqflist, { desc = 'Open diagnostics list' })
...
set('', '<C-b>', '<C-U>')
set('', '<C-f>', '<C-D>')
set({ 'n', 'v', 'o' }, 'H', '^', { noremap = true })
set({ 'n', 'v', 'o' }, 'L', '$', { noremap = true })
set('n', 'Y', 'y$', { noremap = true })
set('i', '<C-t>', require('custom.human_date').prompt_and_insert, { desc = 'Insert parsed date/time' })
...
set('n', ']l', ':lnext<CR>zz', { noremap = true, silent = true })
set('n', '[l', ':lprevious<CR>zz', { noremap = true, silent = true })
set('n', '<leader>q', ':copen')
